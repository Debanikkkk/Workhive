...
export class RolePermissionJoinerAttributeNameChange1714826590454 implements MigrationInterface {
    name = 'RolePermissionJoinerAttributeNameChange1714826590454'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "role_permission" ADD "role_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permission" ADD CONSTRAINT "PK_3d0a7155eafd75ddba5a7013368" PRIMARY KEY ("role_id")`);
        await queryRunner.query(`ALTER TABLE "role_permission" ADD "permission_id" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "role_permission" ADD "permissionId" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "role_permission" ADD CONSTRAINT "PK_72e80be86cab0e93e67ed1a7a9a" PRIMARY KEY ("permissionId")`);
